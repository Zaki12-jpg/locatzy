...
// ✈️ AÉROPORTS PAR PAYS — Liste complète pour tous les pays de PHONE_CODES
// Les proprios peuvent ajouter d'autres aéroports custom via addCustomAirport
const AIRPORTS_BY_COUNTRY = {
  ...
  "Portugal": [
    ...
    "Funchal - Madère (FNC)",
    "Porto Santo (PXO)",
    "Açores - Ponta Delgada (PDL)",
    "Açores - Terceira (TER)",
    "Açores - Horta (HOR)",
    "Açores - Pico (PIX)",
    "Açores - Santa Maria (SMA)",
    "Açores - Flores (FLW)",
    "Açores - São Jorge (SJZ)",
    "Açores - Graciosa (GRW)",
    "Coimbra",
    "Braga",
    "Beja (BYJ)",
  ...
  "Grèce": [
    "Athènes - Eleftherios Venizelos (ATH)",
    "Thessalonique - Makedonia (SKG)",
    "Héraklion - Crète (HER)",
    "La Canée - Crète (CHQ)",
    "Rhodes (RHO)",
    "Corfou (CFU)",
  ...
  "Turquie": [
    "Istanbul - Aéroport d'Istanbul (IST)",
  ...
  "Vietnam": [
    "Hô Chi Minh-Ville - Tan Son Nhat (SGN)",
    "Hanoi - Noi Bai (HAN)",
    "Da Nang (DAD)",
    "Phu Quoc (PQC)",
  ...
  "Indonésie": [
    ...
    "Surabaya - Juanda (SUB)",
    "Medan - Kualanamu (KNO)",
    "Makassar - Hasanuddin (UPG)",
    "Yogyakarta - International (YIA)",
  ...
  "Singapour": [
    ...
    "Singapour - Seletar (XSP)",
  ],
  "Philippines": [
    "Manille - Ninoy Aquino (MNL)",
    "Cebu - Mactan (CEB)",
    "Davao - Francisco Bangoy (DVO)",
    "Clark - Diosdado Macapagal (CRK)",
    "Iloilo (ILO)",
    "Kalibo (KLO)",
    "Puerto Princesa (PPS)",
    "Bohol - Panglao (TAG)",
    "Bacolod-Silay (BCD)",
    "Cagayan de Oro - Laguindingan (CGY)",
    "Zamboanga (ZAM)",
    "General Santos (GES)",
    "Butuan (BXU)",
    "Dumaguete (DGT)",
  ...
  "Mexique": [
    "Mexico - Benito Juárez (MEX)",
    "Mexico - Felipe Ángeles (NLU)",
    "Cancún (CUN)",
    "Guadalajara (GDL)",
    "Monterrey (MTY)",
    "Tijuana (TIJ)",
  ...
  "Sénégal": [
    ...
    "Dakar - Léopold Sédar Senghor (DKR)",
    "Saint-Louis (XLS)",
    "Cap Skirring (CSK)",
    "Ziguinchor (ZIG)",
    "Tambacounda (TUD)",
  ...
  "Côte d'Ivoire": [
    "Abidjan - Félix Houphouët-Boigny (ABJ)",
    "Yamoussoukro (ASK)",
    "Bouaké (BYK)",
    "Korhogo (HGO)",
    "Man (MJC)",
  ...
  "Afrique du Sud": [
    ...
    "Polokwane (PTG)",
    "Nelspruit - Kruger Mpumalanga (MQP)",
    "Upington (UTN)",
    "Hoedspruit (HDS)",
    "Margate (MGH)",
    "Plettenberg Bay (PBZ)",
  ...
  "Nigeria": [
    ...
    "Enugu - Akanu Ibiam (ENU)",
    "Calabar (CBQ)",
    "Owerri - Sam Mbakwe (QOW)",
    "Maiduguri (MIU)",
    "Ilorin (ILR)",
    "Sokoto (SKO)",
    "Yola (YOL)",
  ...
  "Émirats Arabes Unis": [
    "Dubaï - International (DXB)",
    "Dubaï - Al Maktoum (DWC)",
    "Abou Dabi (AUH)",
    "Sharjah (SHJ)",
    "Ras Al Khaïmah (RKT)",
    "Fujaïrah (FJR)",
  ...
  "Arabie Saoudite": [
    "Riyad - King Khalid (RUH)",
    "Djeddah - King Abdulaziz (JED)",
    "Médine - Prince Mohammad bin Abdulaziz (MED)",
    "Dammam - King Fahd (DMM)",
    "La Mecque (via Djeddah)",
    "Taïf (TIF)",
    "Yanbu (YNB)",
    "Tabuk (TUU)",
    "Abha (AHB)",
  ...
  "Israël": [
    "Tel Aviv - Ben Gourion (TLV)",
    "Eilat - Ramon (ETM)",
    "Haïfa (HFA)",
    "Tel Aviv - Sde Dov (SDV)",
  ],
  "Liban": [
    "Beyrouth - Rafic Hariri (BEY)",
  ],
  "Jordanie": [
    "Amman - Queen Alia (AMM)",
    "Amman - Marka (ADJ)",
    "Aqaba - King Hussein (AQJ)",
  ],
  "Haïti": [
    "Port-au-Prince - Toussaint Louverture (PAP)",
    "Cap-Haïtien (CAP)",
    "Jérémie (JEE)",
    "Les Cayes - Antoine-Simon (CYA)",
    "Port-de-Paix (PAX)",
    "Jacmel (JAK)",
  ],
};
                          ...
                          return (
                            <>
                              ...
                              <div style={{ marginBottom: 8 }}>
                                <input
                                  type="text"
                                  placeholder={`🔍 Rechercher un aéroport (parmi ${airports.length})...`}
                                  value={form.airportSearch || ""}
                                  onChange={e => set("airportSearch", e.target.value)}
                                  style={{ width: "100%", padding: 10, border: "1.5px solid #99f6e4", borderRadius: 10, fontSize: 13, outline: "none" }}
                                />
                              </div>

                              <div style={{ display: "flex", flexDirection: "column", gap: 8, maxHeight: 320, overflowY: "auto" }}>
                                {(() => {
                                  const searchTerm = (form.airportSearch || "").toLowerCase().trim();
                                  // Filtrer : si recherche, on filtre ; sinon on montre tous, mais on montre TOUJOURS les cochés en priorité
                                  const filtered = searchTerm
                                    ? airports.filter(a => a.toLowerCase().includes(searchTerm))
                                    : airports;
                                  if (filtered.length === 0) {
                                    return <p style={{ fontSize: 12, color: "#6b7280", padding: 10, textAlign: "center" }}>Aucun aéroport ne correspond à "{searchTerm}"</p>;
                                  }
